...
<script src="{{ asset('js/home/swiper_sliders.js') }}"></script>
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 col-md-6 text-center my-4">
                    <div class="counts-icon mb-3"><img class="img-fluid" src="https://www.drogeriaolmed.pl/images/svg/pro4.svg" alt=""></div>
                    <h2 class="counts-number fs-1" data-toggle="counterUp">142</h2>
                    <h6 class="counts-text fs-5 fw-bold text-secondary">wykonanych badań</h6>
                </div>
                <div class="col-lg-3 col-12 col-md-6 text-center my-4">
                    <div class="counts-icon mb-3"><img class="img-fluid" src="https://www.drogeriaolmed.pl/images/svg/pro4.svg" alt=""></div>
                    <h2 class="counts-number fs-1" data-toggle="counterUp">455</h2>
                    <h6 class="counts-text fs-5 fw-bold text-secondary">pacjentów</h6>
                </div>
                <div class="col-lg-3 col-12 col-md-6 text-center my-4">
                    <div class="counts-icon mb-3"><img class="img-fluid" src="https://www.drogeriaolmed.pl/images/svg/pro4.svg" alt=""></div>
                    <h2 class="counts-number fs-1" data-toggle="counterUp">4,262</h2>
                    <h6 class="counts-text fs-5 fw-bold text-secondary">badań dostępnych w ofercie</h6>
                </div>
                <div class="col-lg-3 col-12 col-md-6 text-center my-4">
                    <div class="counts-icon mb-3"><img class="img-fluid" src="https://www.drogeriaolmed.pl/images/svg/pro4.svg" alt=""></div>
                    <h2 class="counts-number fs-1" data-toggle="counterUp">25</h2>
                    <h6 class="counts-text fs-5 fw-bold text-secondary">średnia ocena z google</h6>
                    <div class="counts-google-icon d-flex justify-content-center">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-3 d-flex flex-column">
                ...
                <div class="mb-3 text-center mt-auto">
                    <a class="btn-green btn fw-bold rounded-pill py-2 px-4" href="#" role="button">KATALOG BADAŃ</a>
                </div>
            </div>
            <div class="col-12 col-lg-3 d-flex flex-column">
                <div class="mb-3 text-center">
                ...
                <div class="mb-3 text-center mt-auto">
                    <a class="btn-green btn fw-bold rounded-pill py-2 px-4" href="#" role="button">WYBIERZ BADANIA</a>
                </div>
            </div>
            <div class="col-12 col-lg-3 d-flex flex-column">
                <div class="mb-3 text-center">
                ...
                <div class="mb-3 text-center mt-auto">
                    <a class="btn-green btn fw-bold rounded-pill py-2 px-4" href="#" role="button">SKONSULTUJ WYNIKI</a>
                </div>
            </div>
            <div class="col-12 col-lg-3 d-flex flex-column">
                <div class="mb-3 text-center">
                ...
                <div class="mt-4 mb-3 mt-auto text-center fw-bold d-flex justify-content-evenly">
                    <a class="facebook-icon text-dark" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                        </svg>
                    </a>
                    <a class="instagram-icon text-dark" href="#">
...
<section class="opinions_and_partners py-5">
    <div class="container bg-grey py-5 rounded">
        <div class="row">
            ...
            <div class="col-12 py-5">
                <div class="opinions-swiper position-relative overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide h-auto">
                            <div class="card p-4 my-3 h-100">
            ...
            <div class="col-12 py-5">
                <div class="partners-swiper position-relative overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide h-auto">
            ...
            <div class="row row-cols-1 row-cols-lg-3 order-1 order-lg-2">
                <div class="col my-3">
                    <div class="card border-0 h-100">
                        ...
                        <div class="card-body h-75">
                            <div class="blog-category d-flex flex-wrap mb-3">
                                <a class="p-0 text-decoration-none nav-link" href="#">
                                    <span class="badge rounded-pill bg-grey fw-bold">Zdrowie</span>
                                </a>
                            </div>
                            <h3 class="card-title fs-6">
                                <a href="#" class="card-link text-decoration-none fw-bold">e-PAKIET DLA KAŻDEGO (MAKSIMUM)</a>
                ...
                <div class="col my-3">
                    <div class="card border-0 h-100">
                        ...
                        <div class="card-body h-75">
                            <div class="blog-category d-flex flex-wrap mb-3">
                                <a class="p-0 text-decoration-none nav-link" href="#">
                                    <span class="badge rounded-pill bg-grey fw-bold">Styl życia</span>
                                </a>
                            </div>
                            <h3 class="card-title fs-6">
